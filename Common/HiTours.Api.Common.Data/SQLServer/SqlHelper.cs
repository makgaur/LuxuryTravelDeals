...
namespace HiTours.Api.Common.Data.SQLServer
{
    ...
    public static class SqlHelper
    {
        ...
        private static Dictionary<string, string> DBCredential { get; set; }

        //public static string connectionString { get; set; }
        //public static string cacheConnectionString { get; set; }
        public static string connectionString
        {
            get
            {
                //Dictionary<string, string> DBCredential = ConfigHandlers.GetDBConfigDynamic();
                return DBCredential["ConnectionString"];
            }
            set { }
        }
        public static string cacheConnectionString
        {
            ...
            {
                //Dictionary<string, string> DBCredential = ConfigHandlers.GetDBConfigDynamic();
                return DBCredential["CacheDBConfigurations"];
            }
            set { }
        }
        ...
        static SqlHelper()
        {
            DBCredential = ConfigHandlers.GetDBConfigDynamic();
        ...
        public static int ExecuteNonQuery(string connectionString, CommandType commandType, string commandText, params SqlParameter[] commandParameters)
        {
            ...
            using (var connection = new SqlConnection(DBCredential[connectionString]))
            {
                connection.Open();
        ...
        public static SqlDataReader ExecuteReader(string connectionString, CommandType commandType, string commandText, params SqlParameter[] commandParameters)
        {
            ...
            try
            {
                connection = new SqlConnection(DBCredential[connectionString]);
                connection.Open();
