...
(function ($) {
    ...
    formatter = {
        ...
        isEmail: function (d) {
            ...
            if (RegE.tldn && a.match(RegE.tldn) == null) {
                return c;
            }
            return e;
        },
